...
class NestedRequestMessage(betterproto2.Message):
    nested_argument: "int" = betterproto2.field(1, betterproto2.FieldDescriptorProtoType.TYPE_INT32)
...
class RequestMessage(betterproto2.Message):
    argument: "int" = betterproto2.field(1, betterproto2.FieldDescriptorProtoType.TYPE_INT32)
