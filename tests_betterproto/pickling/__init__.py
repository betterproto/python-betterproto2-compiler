...
class Complex(betterproto2.Message):
    ...
    foo_str: "str" = betterproto2.field(1, betterproto2.FieldDescriptorProtoType.TYPE_STRING)

    fe: "Fe | None" = betterproto2.field(
        3, betterproto2.FieldDescriptorProtoType.TYPE_MESSAGE, optional=True, group="grp"
    )

    fi: "Fi | None" = betterproto2.field(
        4, betterproto2.FieldDescriptorProtoType.TYPE_MESSAGE, optional=True, group="grp"
    )

    fo: "Fo | None" = betterproto2.field(
        5, betterproto2.FieldDescriptorProtoType.TYPE_MESSAGE, optional=True, group="grp"
    )

    nested_data: "NestedData | None" = betterproto2.field(
        6, betterproto2.FieldDescriptorProtoType.TYPE_MESSAGE, optional=True
    )
...
class Fe(betterproto2.Message):
    abc: "str" = betterproto2.field(1, betterproto2.FieldDescriptorProtoType.TYPE_STRING)
...
class PickledMessage(betterproto2.Message):
    foo: "bool" = betterproto2.field(1, betterproto2.FieldDescriptorProtoType.TYPE_BOOL)

    bar: "int" = betterproto2.field(2, betterproto2.FieldDescriptorProtoType.TYPE_INT32)

    baz: "list[str]" = betterproto2.field(3, betterproto2.FieldDescriptorProtoType.TYPE_STRING, repeated=True)
