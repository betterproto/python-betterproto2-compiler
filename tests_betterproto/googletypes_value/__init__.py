...
class Test(betterproto2.Message):
    ...
    value1: "_google__protobuf__.Value | None" = betterproto2.field(
        1, betterproto2.FieldDescriptorProtoType.TYPE_MESSAGE, optional=True
    )

    value2: "_google__protobuf__.Value | None" = betterproto2.field(
        2, betterproto2.FieldDescriptorProtoType.TYPE_MESSAGE, optional=True
    )

    value3: "_google__protobuf__.Value | None" = betterproto2.field(
        3, betterproto2.FieldDescriptorProtoType.TYPE_MESSAGE, optional=True
    )

    value4: "_google__protobuf__.Value | None" = betterproto2.field(
        4, betterproto2.FieldDescriptorProtoType.TYPE_MESSAGE, optional=True
    )

    value5: "_google__protobuf__.Value | None" = betterproto2.field(
