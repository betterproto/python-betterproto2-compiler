...
# sources: google/protobuf/any.proto, google/protobuf/api.proto, google/protobuf/duration.proto, google/protobuf/empty.proto, google/protobuf/field_mask.proto, google/protobuf/source_context.proto, google/protobuf/struct.proto, google/protobuf/timestamp.proto, google/protobuf/type.proto, google/protobuf/wrappers.proto
...
class Any(betterproto2.Message):
    ...
    type_url: "str" = betterproto2.field(1, betterproto2.FieldDescriptorProtoType.TYPE_STRING)
    """
    ...
    * Applications are allowed to cache lookup results based on the
    ...
    value: "bytes" = betterproto2.field(2, betterproto2.FieldDescriptorProtoType.TYPE_BYTES)
    """
...
class Api(betterproto2.Message):
    ...
    methods: "list[Method]" = betterproto2.field(2, betterproto2.FieldDescriptorProtoType.TYPE_MESSAGE, repeated=True)
    """
    The methods of this interface, in unspecified order.
    """

    options: "list[Option]" = betterproto2.field(3, betterproto2.FieldDescriptorProtoType.TYPE_MESSAGE, repeated=True)
    """
    Any metadata attached to the interface.
    """

    version: "str" = betterproto2.field(4, betterproto2.FieldDescriptorProtoType.TYPE_STRING)
    """
    ...
    mixins: "list[Mixin]" = betterproto2.field(6, betterproto2.FieldDescriptorProtoType.TYPE_MESSAGE, repeated=True)
    """
    Included interfaces. See [Mixin][].
    """

    syntax: "Syntax" = betterproto2.field(
        7, betterproto2.FieldDescriptorProtoType.TYPE_ENUM, default_factory=lambda: Syntax(0)
    )
    """
...
class BoolValue(betterproto2.Message):
    ...
    value: "bool" = betterproto2.field(1, betterproto2.FieldDescriptorProtoType.TYPE_BOOL)
    """
    The bool value.
    """
...
class BytesValue(betterproto2.Message):
    ...
    value: "bytes" = betterproto2.field(1, betterproto2.FieldDescriptorProtoType.TYPE_BYTES)
    """
    The bytes value.
    """
...
class DoubleValue(betterproto2.Message):
    ...
    value: "float" = betterproto2.field(1, betterproto2.FieldDescriptorProtoType.TYPE_DOUBLE)
    """
    The double value.
    """
...
class Duration(betterproto2.Message):
    ...
    seconds: "int" = betterproto2.field(1, betterproto2.FieldDescriptorProtoType.TYPE_INT64)
    """
    ...
    nanos: "int" = betterproto2.field(2, betterproto2.FieldDescriptorProtoType.TYPE_INT32)
    """
...
class Enum(betterproto2.Message):
    ...
    enumvalue: "list[EnumValue]" = betterproto2.field(
        2, betterproto2.FieldDescriptorProtoType.TYPE_MESSAGE, wraps=betterproto2.TYPE_ENUM, repeated=True
    )
    """
    ...
    syntax: "Syntax" = betterproto2.field(
        5, betterproto2.FieldDescriptorProtoType.TYPE_ENUM, default_factory=lambda: Syntax(0)
    )
    """
    The source syntax.
    """

    edition: "str" = betterproto2.field(6, betterproto2.FieldDescriptorProtoType.TYPE_STRING)
    """
...
class Field(betterproto2.Message):
    ...
    kind: "FieldKind" = betterproto2.field(
        1, betterproto2.FieldDescriptorProtoType.TYPE_ENUM, default_factory=lambda: FieldKind(0)
    )
    """
    The field type.
    """
    ...
    cardinality: "FieldCardinality" = betterproto2.field(
        2, betterproto2.FieldDescriptorProtoType.TYPE_ENUM, default_factory=lambda: FieldCardinality(0)
    )
    """
    ...
    name: "str" = betterproto2.field(4, betterproto2.FieldDescriptorProtoType.TYPE_STRING)
    """
    The field name.
    """

    type_url: "str" = betterproto2.field(6, betterproto2.FieldDescriptorProtoType.TYPE_STRING)
    """
    The field type URL, without the scheme, for message or enumeration
    types. Example: `"type.googleapis.com/google.protobuf.Timestamp"`.
    """

    oneof_index: "int" = betterproto2.field(7, betterproto2.FieldDescriptorProtoType.TYPE_INT32)
    """
    The index of the field type in `Type.oneofs`, for message or enumeration
    types. The first type has index 1; zero means the type is not in the list.
    """

    packed: "bool" = betterproto2.field(8, betterproto2.FieldDescriptorProtoType.TYPE_BOOL)
    """
    Whether to use alternative packed wire representation.
    """

    options: "list[Option]" = betterproto2.field(9, betterproto2.FieldDescriptorProtoType.TYPE_MESSAGE, repeated=True)
    """
    ...
    default_value: "str" = betterproto2.field(11, betterproto2.FieldDescriptorProtoType.TYPE_STRING)
    """
...
class FieldMask(betterproto2.Message):
    ...
    paths: "list[str]" = betterproto2.field(1, betterproto2.FieldDescriptorProtoType.TYPE_STRING, repeated=True)
    """
...
class FloatValue(betterproto2.Message):
    ...
    value: "float" = betterproto2.field(1, betterproto2.FieldDescriptorProtoType.TYPE_FLOAT)
    """
    The float value.
    """
...
class Int32Value(betterproto2.Message):
    ...
    value: "int" = betterproto2.field(1, betterproto2.FieldDescriptorProtoType.TYPE_INT32)
    """
    The int32 value.
    """
...
class Int64Value(betterproto2.Message):
    ...
    value: "int" = betterproto2.field(1, betterproto2.FieldDescriptorProtoType.TYPE_INT64)
    """
    The int64 value.
    """
...
class ListValue(betterproto2.Message):
    ...
    values: "list[Value]" = betterproto2.field(1, betterproto2.FieldDescriptorProtoType.TYPE_MESSAGE, repeated=True)
    """
...
class Method(betterproto2.Message):
    ...
    request_type_url: "str" = betterproto2.field(2, betterproto2.FieldDescriptorProtoType.TYPE_STRING)
    """
    A URL of the input message type.
    """

    request_streaming: "bool" = betterproto2.field(3, betterproto2.FieldDescriptorProtoType.TYPE_BOOL)
    """
    If true, the request is streamed.
    """

    response_type_url: "str" = betterproto2.field(4, betterproto2.FieldDescriptorProtoType.TYPE_STRING)
    """
    The URL of the output message type.
    """

    response_streaming: "bool" = betterproto2.field(5, betterproto2.FieldDescriptorProtoType.TYPE_BOOL)
    """
    If true, the response is streamed.
    """

    options: "list[Option]" = betterproto2.field(6, betterproto2.FieldDescriptorProtoType.TYPE_MESSAGE, repeated=True)
    """
...
class Mixin(betterproto2.Message):
    ...
    root: "str" = betterproto2.field(2, betterproto2.FieldDescriptorProtoType.TYPE_STRING)
    """
...
class Option(betterproto2.Message):
    ...
    value: "Any | None" = betterproto2.field(2, betterproto2.FieldDescriptorProtoType.TYPE_MESSAGE, optional=True)
    """
...
class SourceContext(betterproto2.Message):
    ...
    file_name: "str" = betterproto2.field(1, betterproto2.FieldDescriptorProtoType.TYPE_STRING)
    """
...
class Type(betterproto2.Message):
    ...
    fields: "list[Field]" = betterproto2.field(2, betterproto2.FieldDescriptorProtoType.TYPE_MESSAGE, repeated=True)
    """
    The list of fields.
    """

    oneofs: "list[str]" = betterproto2.field(3, betterproto2.FieldDescriptorProtoType.TYPE_STRING, repeated=True)
    """
    The list of types appearing in `oneof` definitions in this type.
    """

    options: "list[Option]" = betterproto2.field(4, betterproto2.FieldDescriptorProtoType.TYPE_MESSAGE, repeated=True)
    """
    The protocol buffer options.
    """
    ...
    syntax: "Syntax" = betterproto2.field(
        6, betterproto2.FieldDescriptorProtoType.TYPE_ENUM, default_factory=lambda: Syntax(0)
    )
    """
    The source syntax.
    """

    edition: "str" = betterproto2.field(7, betterproto2.FieldDescriptorProtoType.TYPE_STRING)
    """
    The source edition string, only valid when syntax is SYNTAX_EDITIONS.
    """
...
class UInt32Value(betterproto2.Message):
    ...
    value: "int" = betterproto2.field(1, betterproto2.FieldDescriptorProtoType.TYPE_UINT32)
    """
    The uint32 value.
    """
...
class UInt64Value(betterproto2.Message):
    ...
    value: "int" = betterproto2.field(1, betterproto2.FieldDescriptorProtoType.TYPE_UINT64)
    """
    The uint64 value.
    """
...
class Value(betterproto2.Message):
    ...
    null_value: "NullValue | None" = betterproto2.field(
        1, betterproto2.FieldDescriptorProtoType.TYPE_ENUM, optional=True, group="kind"
    )
    """
    ...
    number_value: "float | None" = betterproto2.field(
        2, betterproto2.FieldDescriptorProtoType.TYPE_DOUBLE, optional=True, group="kind"
    )
    """
    ...
    string_value: "str | None" = betterproto2.field(
        3, betterproto2.FieldDescriptorProtoType.TYPE_STRING, optional=True, group="kind"
    )
    """
    ...
    bool_value: "bool | None" = betterproto2.field(
        4, betterproto2.FieldDescriptorProtoType.TYPE_BOOL, optional=True, group="kind"
    )
    """
    ...
    struct_value: "Struct | None" = betterproto2.field(
        5, betterproto2.FieldDescriptorProtoType.TYPE_MESSAGE, optional=True, group="kind"
    )
    """
    ...
    list_value: "ListValue | None" = betterproto2.field(
        6, betterproto2.FieldDescriptorProtoType.TYPE_MESSAGE, optional=True, group="kind"
    )
    """
