...
class ExampleRequest(betterproto2.Message):
    example_string: "str" = betterproto2.string_field(1)
    example_integer: "int" = betterproto2.int64_field(2)
...
class TestStub(betterproto2.ServiceStub):
    ...
    async def example_stream_unary(
        self,
        example_request_iterator: "Union[AsyncIterable[ExampleRequest], Iterable[ExampleRequest]]",
        *,
        timeout: Optional[float] = None,
        deadline: "Optional[Deadline]" = None,
        metadata: "Optional[MetadataLike]" = None,
...
class TestBase(ServiceBase):
    ...
    async def example_stream_unary(self, example_request_iterator: AsyncIterator[ExampleRequest]) -> "ExampleResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
