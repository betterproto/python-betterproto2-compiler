...
class DoThingRequest(betterproto2.Message):
    ...
    comments: "list[str]" = betterproto2.field(2, betterproto2.FieldDescriptorProtoType.TYPE_STRING, repeated=True)

    type: "ThingType" = betterproto2.field(
        3, betterproto2.FieldDescriptorProtoType.TYPE_ENUM, default_factory=lambda: ThingType(0)
    )
...
class DoThingResponse(betterproto2.Message):
    names: "list[str]" = betterproto2.field(1, betterproto2.FieldDescriptorProtoType.TYPE_STRING, repeated=True)
...
class GetThingResponse(betterproto2.Message):
    ...
    version: "int" = betterproto2.field(2, betterproto2.FieldDescriptorProtoType.TYPE_INT32)
