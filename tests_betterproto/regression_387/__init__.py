...
class ParentElement(betterproto2.Message):
    ...
    elems: "list[Test]" = betterproto2.field(2, betterproto2.FieldDescriptorProtoType.TYPE_MESSAGE, repeated=True)
...
class Test(betterproto2.Message):
    id: "int" = betterproto2.field(1, betterproto2.FieldDescriptorProtoType.TYPE_UINT64)
