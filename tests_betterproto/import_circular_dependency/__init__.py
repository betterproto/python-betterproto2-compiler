...
class Test(betterproto2.Message):
    ...
    message: "Optional[RootPackageMessage]" = betterproto2.message_field(1, optional=True)
    other_value: "Optional[other.OtherPackageMessage]" = betterproto2.message_field(2, optional=True)
