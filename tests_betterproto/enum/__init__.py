...
class Test(betterproto2.Message):
    ...
    choice: "Choice" = betterproto2.field(
        1, betterproto2.FieldDescriptorProtoType.TYPE_ENUM, default_factory=lambda: Choice(0)
    )

    choices: "list[Choice]" = betterproto2.field(2, betterproto2.FieldDescriptorProtoType.TYPE_ENUM, repeated=True)
