...
class DescriptorProto(betterproto2.Message):
    ...
    options: "Optional[MessageOptions]" = betterproto2.message_field(7, optional=True)
...
class DescriptorProtoExtensionRange(betterproto2.Message):
    ...
    Exclusive.
    """
    options: "Optional[ExtensionRangeOptions]" = betterproto2.message_field(3, optional=True)
...
class EnumDescriptorProto(betterproto2.Message):
    ...
    options: "Optional[EnumOptions]" = betterproto2.message_field(3, optional=True)
...
class EnumValueDescriptorProto(betterproto2.Message):
    ...
    options: "Optional[EnumValueOptions]" = betterproto2.message_field(3, optional=True)
...
class FieldDescriptorProto(betterproto2.Message):
    ...
    it to camelCase.
    """
    options: "Optional[FieldOptions]" = betterproto2.message_field(8, optional=True)
...
class FileDescriptorProto(betterproto2.Message):
    ...
    options: "Optional[FileOptions]" = betterproto2.message_field(8, optional=True)
    source_code_info: "Optional[SourceCodeInfo]" = betterproto2.message_field(9, optional=True)
    """
...
class MethodDescriptorProto(betterproto2.Message):
    ...
    options: "Optional[MethodOptions]" = betterproto2.message_field(4, optional=True)
...
class OneofDescriptorProto(betterproto2.Message):
    ...
    name: "str" = betterproto2.string_field(1)
    options: "Optional[OneofOptions]" = betterproto2.message_field(2, optional=True)
...
class ServiceDescriptorProto(betterproto2.Message):
    ...
    options: "Optional[ServiceOptions]" = betterproto2.message_field(3, optional=True)
