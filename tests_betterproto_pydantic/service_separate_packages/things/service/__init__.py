...
class TestBase(ServiceBase):
    async def do_thing(self, messages_do_thing_request: "_messages__.DoThingRequest") -> "_messages__.DoThingResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def do_many_things(
        self, messages_do_thing_request_iterator: AsyncIterator[_messages__.DoThingRequest]
    ) -> "_messages__.DoThingResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def get_different_things(
        self, messages_get_thing_request_iterator: AsyncIterator[_messages__.GetThingRequest]
    ) -> AsyncIterator[_messages__.GetThingResponse]:
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
