...
class Test(betterproto2.Message):
    ...
    x: "int" = betterproto2.field(1, betterproto2.FieldDescriptorProtoType.TYPE_UINT32)
    """
    ...
    a: "int | None" = betterproto2.field(
        2, betterproto2.FieldDescriptorProtoType.TYPE_INT32, optional=True, group="oneof_example"
    )
    """
