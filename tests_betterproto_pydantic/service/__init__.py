...
class DoThingRequest(betterproto2.Message):
    ...
    type: "ThingType" = betterproto2.enum_field(3, enum_default_value=lambda: ThingType.try_value(0))
...
class TestBase(ServiceBase):
    ...
    async def do_many_things(self, do_thing_request_iterator: AsyncIterator[DoThingRequest]) -> "DoThingResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def get_thing_versions(self, get_thing_request: "GetThingRequest") -> AsyncIterator[GetThingResponse]:
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
