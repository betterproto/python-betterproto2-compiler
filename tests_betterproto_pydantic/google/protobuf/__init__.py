...
class Any(betterproto2.Message):
    ...
    type_url: "typing.Annotated[str, pydantic.AfterValidator(betterproto2.validators.validate_string)]" = (
...
class Api(betterproto2.Message):
    ...
    version: "typing.Annotated[str, pydantic.AfterValidator(betterproto2.validators.validate_string)]" = (
...
class Duration(betterproto2.Message):
    ...
    seconds: "typing.Annotated[int, pydantic.Field(ge=-2**63, le=2**63 - 1)]" = betterproto2.field(
...
class Enum(betterproto2.Message):
    ...
    edition: "typing.Annotated[str, pydantic.AfterValidator(betterproto2.validators.validate_string)]" = (
...
class FieldMask(betterproto2.Message):
    ...
    paths: "list[typing.Annotated[str, pydantic.AfterValidator(betterproto2.validators.validate_string)]]" = (
...
class FloatValue(betterproto2.Message):
    ...
    value: "typing.Annotated[float, pydantic.AfterValidator(betterproto2.validators.validate_float32)]" = (
        betterproto2.field(1, betterproto2.TYPE_FLOAT)
    )
    """
    The float value.
    """
...
class Method(betterproto2.Message):
    ...
    request_type_url: "typing.Annotated[str, pydantic.AfterValidator(betterproto2.validators.validate_string)]" = (
    ...
    response_type_url: "typing.Annotated[str, pydantic.AfterValidator(betterproto2.validators.validate_string)]" = (
        betterproto2.field(4, betterproto2.TYPE_STRING)
    )
    """
...
class Mixin(betterproto2.Message):
    ...
    root: "typing.Annotated[str, pydantic.AfterValidator(betterproto2.validators.validate_string)]" = (
        betterproto2.field(2, betterproto2.TYPE_STRING)
    )
    """
...
class SourceContext(betterproto2.Message):
    ...
    file_name: "typing.Annotated[str, pydantic.AfterValidator(betterproto2.validators.validate_string)]" = (
        betterproto2.field(1, betterproto2.TYPE_STRING)
    )
    """
...
class Type(betterproto2.Message):
    ...
    oneofs: "list[typing.Annotated[str, pydantic.AfterValidator(betterproto2.validators.validate_string)]]" = (
...
class UInt32Value(betterproto2.Message):
    ...
    value: "typing.Annotated[int, pydantic.Field(ge=0, le=2**32 - 1)]" = betterproto2.field(1, betterproto2.TYPE_UINT32)
    """
    The uint32 value.
    """
...
class UInt64Value(betterproto2.Message):
    ...
    value: "typing.Annotated[int, pydantic.Field(ge=0, le=2**64 - 1)]" = betterproto2.field(1, betterproto2.TYPE_UINT64)
    """
    The uint64 value.
    """
...
class Value(betterproto2.Message):
    ...
    string_value: "typing.Annotated[str, pydantic.AfterValidator(betterproto2.validators.validate_string)] | None" = (
        betterproto2.field(3, betterproto2.TYPE_STRING, optional=True, group="kind")
    )
    """
