...
class InnerNested(betterproto2.Message):
    a: "bool | None" = betterproto2.field(1, betterproto2.FieldDescriptorProtoType.TYPE_BOOL, optional=True)
...
class Nested(betterproto2.Message):
    inner: "InnerNested | None" = betterproto2.field(
...
class Test(betterproto2.Message):
    ...
    nested: "Nested | None" = betterproto2.field(
        1, betterproto2.FieldDescriptorProtoType.TYPE_MESSAGE, optional=True, group="kind"
    )

    with_optional: "WithOptional | None" = betterproto2.field(
        2, betterproto2.FieldDescriptorProtoType.TYPE_MESSAGE, optional=True, group="kind"
    )
...
class WithOptional(betterproto2.Message):
    b: "bool | None" = betterproto2.field(2, betterproto2.FieldDescriptorProtoType.TYPE_BOOL, optional=True)
