...
class ExampleRequest(betterproto2.Message):
    example_string: "str" = betterproto2.field(1, betterproto2.FieldDescriptorProtoType.TYPE_STRING)

    example_integer: "int" = betterproto2.field(2, betterproto2.FieldDescriptorProtoType.TYPE_INT64)
