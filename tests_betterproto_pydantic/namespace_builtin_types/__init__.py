...
class Test(betterproto2.Message):
    ...
    str: "builtins.typing.Annotated[str, pydantic.AfterValidator(betterproto2.validators.validate_string)]" = (
    ...
    bytearray: "builtins.typing.Annotated[str, pydantic.AfterValidator(betterproto2.validators.validate_string)]" = (
    ...
    bytes: "builtins.typing.Annotated[str, pydantic.AfterValidator(betterproto2.validators.validate_string)]" = (
    ...
    memoryview: "builtins.typing.Annotated[str, pydantic.AfterValidator(betterproto2.validators.validate_string)]" = (
    ...
    set: "builtins.typing.Annotated[str, pydantic.AfterValidator(betterproto2.validators.validate_string)]" = (
    ...
    frozenset: "builtins.typing.Annotated[str, pydantic.AfterValidator(betterproto2.validators.validate_string)]" = (
        betterproto2.field(12, betterproto2.TYPE_STRING)
    )

    map: "builtins.typing.Annotated[str, pydantic.AfterValidator(betterproto2.validators.validate_string)]" = (
    ...
    dict: "builtins.typing.Annotated[str, pydantic.AfterValidator(betterproto2.validators.validate_string)]" = (
        betterproto2.field(14, betterproto2.TYPE_STRING)
    )

    bool: "builtins.typing.Annotated[str, pydantic.AfterValidator(betterproto2.validators.validate_string)]" = (
