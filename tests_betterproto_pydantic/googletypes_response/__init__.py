...
class TestBase(ServiceBase):
    ...
    async def get_double(self, input: "Input") -> "betterproto_lib_pydantic_google_protobuf.DoubleValue":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def get_float(self, input: "Input") -> "betterproto_lib_pydantic_google_protobuf.FloatValue":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def get_int64(self, input: "Input") -> "betterproto_lib_pydantic_google_protobuf.Int64Value":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def get_u_int64(self, input: "Input") -> "betterproto_lib_pydantic_google_protobuf.UInt64Value":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def get_int32(self, input: "Input") -> "betterproto_lib_pydantic_google_protobuf.Int32Value":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def get_u_int32(self, input: "Input") -> "betterproto_lib_pydantic_google_protobuf.UInt32Value":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def get_bool(self, input: "Input") -> "betterproto_lib_pydantic_google_protobuf.BoolValue":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def get_string(self, input: "Input") -> "betterproto_lib_pydantic_google_protobuf.StringValue":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def get_bytes(self, input: "Input") -> "betterproto_lib_pydantic_google_protobuf.BytesValue":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def __rpc_get_double(
        self, stream: "grpclib.server.Stream[Input, betterproto_lib_pydantic_google_protobuf.DoubleValue]"
    ) -> None:
    ...
    async def __rpc_get_float(
        self, stream: "grpclib.server.Stream[Input, betterproto_lib_pydantic_google_protobuf.FloatValue]"
    ) -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_get_int64(
        self, stream: "grpclib.server.Stream[Input, betterproto_lib_pydantic_google_protobuf.Int64Value]"
    ) -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_get_u_int64(
        self, stream: "grpclib.server.Stream[Input, betterproto_lib_pydantic_google_protobuf.UInt64Value]"
    ) -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_get_int32(
        self, stream: "grpclib.server.Stream[Input, betterproto_lib_pydantic_google_protobuf.Int32Value]"
    ) -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_get_u_int32(
        self, stream: "grpclib.server.Stream[Input, betterproto_lib_pydantic_google_protobuf.UInt32Value]"
    ) -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_get_bool(
        self, stream: "grpclib.server.Stream[Input, betterproto_lib_pydantic_google_protobuf.BoolValue]"
    ) -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_get_string(
        self, stream: "grpclib.server.Stream[Input, betterproto_lib_pydantic_google_protobuf.StringValue]"
    ) -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_get_bytes(
        self, stream: "grpclib.server.Stream[Input, betterproto_lib_pydantic_google_protobuf.BytesValue]"
    ) -> None:
        request = await stream.recv_message()
