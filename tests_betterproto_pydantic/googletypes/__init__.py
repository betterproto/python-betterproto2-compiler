...
class Test(betterproto2.Message):
    ...
    important: "int | None | None" = betterproto2.field(
        4, betterproto2.FieldDescriptorProtoType.TYPE_MESSAGE, wraps=betterproto2.TYPE_INT32, optional=True
    )

    empty: "_google__protobuf__.Empty | None" = betterproto2.field(
