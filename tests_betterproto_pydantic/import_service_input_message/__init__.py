...
class NestedRequestMessage(betterproto2.Message):
    nested_argument: "typing.Annotated[int, pydantic.Field(ge=-2**31, le=2**31 - 1)]" = betterproto2.field(
...
class RequestMessage(betterproto2.Message):
    argument: "typing.Annotated[int, pydantic.Field(ge=-2**31, le=2**31 - 1)]" = betterproto2.field(
        1, betterproto2.TYPE_INT32
    )
