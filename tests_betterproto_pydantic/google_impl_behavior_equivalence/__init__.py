...
class Foo(betterproto2.Message):
    bar: "int" = betterproto2.field(1, betterproto2.FieldDescriptorProtoType.TYPE_INT64)
...
class Request(betterproto2.Message):
    foo: "Empty | None" = betterproto2.field(1, betterproto2.FieldDescriptorProtoType.TYPE_MESSAGE, optional=True)
...
class Test(betterproto2.Message):
    ...
    string: "str | None" = betterproto2.field(
        1, betterproto2.FieldDescriptorProtoType.TYPE_STRING, optional=True, group="group"
    )

    integer: "int | None" = betterproto2.field(
        2, betterproto2.FieldDescriptorProtoType.TYPE_INT64, optional=True, group="group"
    )

    foo: "Foo | None" = betterproto2.field(
        3, betterproto2.FieldDescriptorProtoType.TYPE_MESSAGE, optional=True, group="group"
    )
