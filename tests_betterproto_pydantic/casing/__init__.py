...
class Test(betterproto2.Message):
    camel_case: "int" = betterproto2.field(1, betterproto2.FieldDescriptorProtoType.TYPE_INT32)

    snake_case: "MyEnum" = betterproto2.field(
        2, betterproto2.FieldDescriptorProtoType.TYPE_ENUM, default_factory=lambda: MyEnum(0)
    )

    snake_case_message: "SnakeCaseMessage | None" = betterproto2.field(
        3, betterproto2.FieldDescriptorProtoType.TYPE_MESSAGE, optional=True
    )

    uppercase: "int" = betterproto2.field(4, betterproto2.FieldDescriptorProtoType.TYPE_INT32)
