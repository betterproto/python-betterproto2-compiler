...
class Sibling(betterproto2.Message):
    foo: "int" = betterproto2.field(1, betterproto2.FieldDescriptorProtoType.TYPE_INT32)
...
class Test(betterproto2.Message):
    ...
    nested: "TestNested | None" = betterproto2.field(
        1, betterproto2.FieldDescriptorProtoType.TYPE_MESSAGE, optional=True
    )

    sibling: "Sibling | None" = betterproto2.field(2, betterproto2.FieldDescriptorProtoType.TYPE_MESSAGE, optional=True)

    sibling2: "Sibling | None" = betterproto2.field(
        3, betterproto2.FieldDescriptorProtoType.TYPE_MESSAGE, optional=True
    )

    msg: "TestMsg" = betterproto2.field(
        4, betterproto2.FieldDescriptorProtoType.TYPE_ENUM, default_factory=lambda: TestMsg(0)
    )
...
class TestNested(betterproto2.Message):
    ...
    count: "int" = betterproto2.field(1, betterproto2.FieldDescriptorProtoType.TYPE_INT32)
    """
