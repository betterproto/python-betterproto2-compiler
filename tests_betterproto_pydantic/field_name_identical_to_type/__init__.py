...
class Test(betterproto2.Message):
    ...
    int: "builtins.typing.Annotated[int, pydantic.Field(ge=-2**31, le=2**31 - 1)]" = betterproto2.field(
        1, betterproto2.TYPE_INT32
    )

    float: "builtins.typing.Annotated[float, pydantic.AfterValidator(betterproto2.validators.validate_float32)]" = (
